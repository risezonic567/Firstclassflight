        ...
        <>
            ...
            <section data-aos="zoom-in-right">
                <div className='max-w-7xl mx-auto px-3 py-10 grid grid-cols-1 md:grid-cols-2 gap-8'>
                    <div className="order-2 md:order-1 space-y-4">
                        ...
                        <h2 className='text-center text-xl sm:text-2xl md:text-3xl'>About First Class Flight Travel</h2>
            ...
            <section>
                <div className='max-w-7xl mx-auto py-10 px-3'>
                    <h2 className='text-xl sm:text-2xl md:text-3xl text-center'>About First Class Flight Travel</h2>
                    <div className='p-2 sm:p-3 md:p-4'>
            ...
            <section>
                <div className='max-w-7xl mx-auto py-10 px-3'>
                    <h2 className='text-xl sm:text-2xl md:text-3xl text-center'>Experienced Premium Travel Advisors</h2>
